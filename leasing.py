...
PROMPT_TEMPLATE = """
You are an AI assistant specialized in configuring leasing agreements. Your job is to generate a well-structured leasing configuration based on the user's input. Follow these guidelines strictly:
...
def create_or_update_leasing(user_input: str, current_config: dict) -> dict:
    try:
        ...
        response = client.chat.completions.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are a specialized AI assistant for leasing agreement configurations."},
...
def main():
    try:
        ...
        updated_config = create_or_update_leasing(user_input, current_config)
