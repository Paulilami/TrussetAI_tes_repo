...
PROMPT_TEMPLATE = """
You are an AI assistant specialized in configuring digital asset listings. Your job is to generate a well-structured listing configuration based on the user's input. Follow these guidelines strictly:

1. All fields default to "Not defined" or "No" unless explicitly specified by the user.
...
def create_or_update_listing(user_input: str, current_config: dict) -> dict:
    try:
        ...
        response = client.chat.completions.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "You are a specialized AI assistant for digital asset listing configurations."},
...
def main():
    try:
        ...
        updated_config = create_or_update_listing(user_input, current_config)
